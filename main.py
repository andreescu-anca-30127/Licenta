...
def ANN(Y_train, output, batch, epochs, error,num_layers,num_neurons):
    ...
    classifier.summary()
    create_optimizer = Adam(learning_rate=0.4e-3, epsilon = 1e-08)
...
yhat, bias, weights = ANN(Y_train, output=1, batch=5, epochs=100, error='mse',num_layers=1,num_neurons=23)
